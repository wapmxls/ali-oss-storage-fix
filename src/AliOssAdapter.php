...
class AliOssAdapter extends AbstractAdapter
{
    ...
    public function getUrl( $path )
    {
        ...
        return ( $this->ssl ? 'https://' : 'http://' ) . ( $this->isCname ? ( $this->cdnDomain == '' ? $this->endPoint : $this->cdnDomain ) : $this->bucket . '.' . $this->endPoint ) . '/' .'upload/'.ltrim($path, '/');
    }
